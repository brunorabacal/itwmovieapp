    ...
    return {
        ...
        activate: function () {
            router.map([
                ...
                { route: 'directors', title: 'Directors', moduleId: 'viewmodels/directors', nav: true, menu: '<i class="fa fa-video-camera"></i>' },
                { route: 'actors', title: 'Actors', moduleId: 'viewmodels/actors', nav: true, menu: '<i class="fa fa-user"></i>' },
                { route: 'movies', title: 'Movies', moduleId: 'viewmodels/movies', nav: true, menu: '<i class="fa fa-film"></i>' },
